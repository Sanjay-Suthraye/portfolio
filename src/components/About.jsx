  ...
  return (
    <section id="about" className="bg-white dark:bg-dark-800 py-20 px-6 border-t border-slate-100 dark:border-dark-700">
      <div className="max-w-3xl mx-auto animate-fade-in">
        <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-12 uppercase tracking-widest text-center">
          About Me
        </h3>

        <div className="space-y-6 text-center md:text-left">
          <p className="text-slate-700 dark:text-slate-200 leading-loose text-lg">
        ...
        <div className="mt-12 flex justify-center gap-8">
          <a href={socials.github} target="_blank" rel="noopener noreferrer"
            className="text-4xl text-slate-400 hover:text-black dark:hover:text-white transition-colors duration-300" aria-label="GitHub">
            <FiGithub />
          </a>
          <a href={socials.linkedin} target="_blank" rel="noopener noreferrer"
            className="text-4xl text-slate-400 hover:text-blue-700 dark:hover:text-blue-400 transition-colors duration-300" aria-label="LinkedIn">
            <FiLinkedin />
          </a>
          <a href={socials.email}
            className="text-4xl text-slate-400 hover:text-red-500 dark:hover:text-red-400 transition-colors duration-300" aria-label="Email">
            <FiMail />
          </a>
        </div>
      </div>
